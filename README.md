...
Name It is a simple web application to find a good name for your next venture/initiative. The app suggests you name ideas, facility to check if domain names are available for that keyword in [Name Cheap](https://www.namecheap.com/)
